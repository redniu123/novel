...
| TASK-003 | 走量小说生产策略总任务 | `pending_design_review` | `docs/TASK-003-volume-strategy-design` | TASK-002 | 总体设计、任务拆分、总体验收 | 参数已冻结并拆分；15 项源码事实复核修订完成，等待设计复审 |
| TASK-003A | 走量策略与商业状态 Schema | `pending_design_review` | `docs/TASK-003-volume-strategy-design` | TASK-003 设计复审 | Policy、State v1、Store、映射和发布资格 | 公开结果适配和配置读取链已校正；实现分支待复审后创建 |
